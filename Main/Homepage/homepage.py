...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.work_timer_button_right = tk.Button(self.menu_buttons_frame_right, text="Work Timer", width=self.button_width, height=self.button_height)
    ...
    def toggle_menu(self):
        if self.menu_visible:
            ...
            self.work_timer_button_right.grid(row=2, column=0, sticky="ew", pady=self.button_y_padding)
